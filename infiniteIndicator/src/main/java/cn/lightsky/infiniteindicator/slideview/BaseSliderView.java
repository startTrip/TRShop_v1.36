...
//     loadByImageLoader(v,targetImageView);
     ...
     * @param targetImageView where to place image
     */
    protected void bind3EventAndShow(final View v, ImageView targetImageView,String url){
        final BaseSliderView me = this;
...
//     loadByImageLoader(v,targetImageView);
        load3ByPicasso(v,targetImageView,url);
   }
    public void load3ByPicasso(final View v, ImageView targetImageView,String url) {
        final BaseSliderView me = this;
        Picasso p = Picasso.with(mContext);
        RequestCreator rq = null;
        rq = p.load(url);   
