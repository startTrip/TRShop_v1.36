...
public class ProgressActivity extends RelativeLayout {
    ...
    LinearLayout loadingStateLinearLayoutt;
...
//错误背景颜色默认透明
    ...
    private void setLoadingView() {
        if (loadingStateLinearLayoutt == null) {
            view = inflater.inflate(R.layout.progress_loading_view, null);
            loadingStateLinearLayoutt = (LinearLayout) view.findViewById(R.id.loadingStateLinearLayout);
            loadingStateLinearLayoutt.setTag(TAG_LOADING);
            iv_route = (ImageView) view.findViewById(R.id.iv_route);
            ...
            addView(loadingStateLinearLayoutt, layoutParams);
        } else {
        	loadingStateLinearLayoutt.setVisibility(VISIBLE);
        }
    ...
    private void hideLoadingView() {
        if (loadingStateLinearLayoutt != null) {
        	...
        	loadingStateLinearLayoutt.setVisibility(GONE);
