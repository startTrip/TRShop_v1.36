...
import shop.trqq.com.util.PixelUtil;
...
public final class CameraManager {
    ...
    //改善指定长宽在大屏扫描框过小
    private static final int MIN_FRAME_WIDTH = (int) PixelUtil.dp2px(180);
    private static final int MIN_FRAME_HEIGHT = (int) PixelUtil.dp2px(180);
    private static final int MAX_FRAME_WIDTH = (int) PixelUtil.dp2px(240);
    private static final int MAX_FRAME_HEIGHT = (int) PixelUtil.dp2px(240);
